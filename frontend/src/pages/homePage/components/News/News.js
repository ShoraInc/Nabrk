...
export default function News() {
  ...
  const handleViewAllClick = () => {
    // Здесь можно добавить навигацию к странице всех новостей
    console.log('View all news');
    // Например: navigate('/news');
  };
        ...
        <div className="news-image" style={{ 
          ...
          <div style={{
            ...
            <p style={{
              ...
              opacity: 0.7,
              margin: 0
            }}>Әзірге жарияланған жаңалықтар табылмады</p>
          </div>
        </div>
      </div>
      {[...Array(4)].map((_, index) => (
        ...
        <div className="news-image" style={{ 
          ...
          <div style={{
            ...
            <p style={{
              ...
              opacity: 0.8,
              margin: '0 0 16px 0'
            }}>Жаңалықтарды жүктеу мүмкін болмады</p>
            <button 
              onClick={loadNews}
              style={{
                padding: '8px 16px',
                  ...
                  <div className="news-overlay">
                    <div className="news-content">
                      ...
                      <div className="news-bottom">
                        ...
                        {news.isLarge && (
                          <button className="news-button desktop-only">
                            ТОЛЫҚТАЙ ОҚУ
                        ...
                        <img
                          src={ArrowIcon}
                          className={`arrow-only ${news.isLarge ? 'mobile-only' : ''}`}
                          alt="arrow"
                        />
                      </div>
                    </div>
