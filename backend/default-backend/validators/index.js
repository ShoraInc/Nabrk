...
const { validateTextBlock } = require("./textValidator");
const { validateImageBlock } = require("./imageValidator");
...
const validateBlockData = (type, data) => {
  switch (type) {
    ...
    case "text":
      return validateTextBlock(data);
      
    case "image":
      return validateImageBlock(data);
